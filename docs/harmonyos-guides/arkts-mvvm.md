...
[-   管理中心](https://developer.huawei.com/consumer/cn/console)[-   个人中心](https://developer.huawei.com/consumer/cn/personalcenter/overview)
[-   我的学堂](https://developer.huawei.com/consumer/cn/training/mine/)[-   我的收藏](https://developer.huawei.com/consumer/cn/personalcenter/myInfo/myCollection)[-   我的活动](https://developer.huawei.com/consumer/cn/personalcenter/myActivity/activityList)[-   我的工单](https://developer.huawei.com/consumer/cn/personalcenter/myCustom/ticketlist)
...
[Background Tasks Kit（后台任务开发服务）](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/background-task-kit)

[Core File Kit（文件基础服务）](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/core-file-kit)

[Data Augmentation Kit（数据增强服务）](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/data-augmentation-kit-guide)

[Form Kit（卡片开发服务）](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/form-kit)

[IME Kit（输入法开发服务）](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ime-kit)

[IPC Kit（进程间通信服务）](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ipc-kit)

[Localization Kit（本地化开发服务）](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/localization-kit)

[UI Design Kit（UI设计套件）](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ui-design-kit-guide)
...
指南应用框架[ArkUI（方舟UI框架）](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkui)[UI开发 (ArkTS声明式开发范式)](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-ui-development)[学习UI范式状态管理](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-state-management)MVVM模式（V1）
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bc/v3/30lwIGZFSaONFilpJwC5Pg/zh-cn_image_0000002525984232.png?HW-CC-KV=V1&HW-CC-Date=20260311T194542Z&HW-CC-Expire=86400&HW-CC-Sign=012D90B72201270FE9C7172FA87AC7106D93285CB7A7B134C3468FD36142F334)
...
7.      Column() {
8.        Row() {
9.          // 请将$r('app.string.all\_tasks')替换为实际资源文件，在本示例中该资源文件的value值为"全部待办"
10.          Text($r('app.string.all\_tasks'))
11.            .fontSize(30)
...
28.              .height(28)
29.          }
30.          // 请将$r('app.string.all\_learn\_advanced\_math')替换为实际资源文件，在本示例中该资源文件的value值为"学习高数"
31.          Text($r('app.string.learn\_advanced\_math'))
32.            .fontSize(24)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/35/v3/e-neKAW-TWOMMcsnjx40Iw/zh-cn_image_0000002557224075.gif?HW-CC-KV=V1&HW-CC-Date=20260311T194542Z&HW-CC-Expire=86400&HW-CC-Sign=74CD402B0F6C692CC607710AD2641A083A3D6FC22824E52A33A3830D6BDD259B)
...
3.    build() {
4.      Row() {
5.        // 请将$r('app.string.all\_tasks')替换为实际资源文件，在本示例中该资源文件的value值为"全部待办"
6.        Text($r('app.string.all\_tasks'))
7.          .fontSize(30)
...
19.    build() {
20.      Row() {
21.        // 请将$r('app.string.check\_all')替换为实际资源文件，在本示例中该资源文件的value值为"全选"
22.        Button($r('app.string.check\_all'), { type: ButtonType.Normal })
23.          .onClick(() => {
...
52.            .height(28)
53.        }
54.        // 请将$r('app.string.learn\_chinese')替换为实际资源文件，在本示例中该资源文件的value值为"学习语文"
55.        Text($r('app.string.learn\_chinese'))
56.          .fontSize(24)
...
85.            .height(28)
86.        }
87.        // 请将$r('app.string.learn\_advanced\_math')替换为实际资源文件，在本示例中该资源文件的value值为"学习高数"
88.        Text($r('app.string.learn\_advanced\_math'))
89.          .fontSize(24)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/43/v3/sdSPvh9ATA-T5GVywH3VIg/zh-cn_image_0000002526144180.gif?HW-CC-KV=V1&HW-CC-Date=20260311T194542Z&HW-CC-Expire=86400&HW-CC-Sign=8EE9BB635118B18003BC4B176609B3FF11DAF89FD9619ED176972E164F934B25)
...
79.      // 请将$r('app.string.get\_up')替换为实际资源文件，在本示例中该资源文件的value值为"7.30 起床"
80.      $r('app.string.get\_up'),
...
87.      // 请将$r('app.string.midnight\_snack')替换为实际资源文件，在本示例中该资源文件的value值为"21.30 夜宵"
88.      $r('app.string.midnight\_snack'),
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e4/v3/WTyRp3DgR9ikfcJLusOcIw/zh-cn_image_0000002557104099.gif?HW-CC-KV=V1&HW-CC-Date=20260311T194542Z&HW-CC-Expire=86400&HW-CC-Sign=C8E0780EEA693BAC9397DEA52F784758230F477ECC7005755AE6AC2D80B23D4F)
...
4.      // 请将$r('app.string.get\_up')替换为实际资源文件，在本示例中该资源文件的value值为"7.30 起床"
5.      $r('app.string.get\_up'),
...
12.      // 请将$r('app.string.midnight\_snack')替换为实际资源文件，在本示例中该资源文件的value值为"21.30 夜宵"
13.      $r('app.string.midnight\_snack'),
...
23.    build() {
24.      Row() {
25.        // 请将$r('app.string.all\_tasks')替换为实际资源文件，在本示例中该资源文件的value值为"全部待办"
26.        Text($r('app.string.all\_tasks'))
27.          .fontSize(30)
...
39.    build() {
40.      Row() {
41.        // 请将$r('app.string.check\_all')替换为实际资源文件，在本示例中该资源文件的value值为"全选"
42.        Button($r('app.string.check\_all'), { type: ButtonType.Capsule })
43.          .onClick(() => {
...
85.          .onClick(() => {
86.            // 请将$r('app.string.la\_la')替换为实际资源文件，在本示例中该资源文件的value值为"啦"
87.            this.thing += this.getUIContext().getHostContext()!.resourceManager.getStringSync($r('app.string.la\_la').id);
88.          })
89.      }
90.      .height('8%')
91.      .width('90%')
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/54/v3/AkEnM0vjTq27FPwT6Lmrag/zh-cn_image_0000002525984234.gif?HW-CC-KV=V1&HW-CC-Date=20260311T194542Z&HW-CC-Expire=86400&HW-CC-Sign=41CF13FF2493BE85972E528F7AEBD19777CC936C08CDF3544F502254C3C75BB4)
...
17.      try {
18.        let getJson = await context.resourceManager.getRawFileContent('default\_tasks.json');
...
7.    // 请在resources\\base\\element\\string.json文件中配置name为'check\_all'，value为非空字符串的资源
8.    @State titleName: ResourceStr = this.context1.resourceManager.getStringSync($r('app.string.check\_all').id);
...
17.              // 请在resources\\base\\element\\string.json文件中配置name为'check\_all'，value为非空字符串的资源
18.              this.context1.resourceManager.getStringSync($r('app.string.check\_all').id)
19.              // 请在resources\\base\\element\\string.json文件中配置name为'deselect\_all'，value为非空字符串的资源
20.              : this.context1.resourceManager.getStringSync($r('app.string.deselect\_all').id);
21.          })
22.          .fontSize(30)
...
18.    addSuffixes(): void {
19.      // 请在resources\\base\\element\\string.json文件中配置name为'la\_la'，value为非空字符串的资源
20.      this.thingName += this.context.resourceManager.getStringSync($r('app.string.la\_la').id);
21.    }
22.  }
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/89/v3/0nJlI48YTXGVrCf80VK_DQ/zh-cn_image_0000002557224077.gif?HW-CC-KV=V1&HW-CC-Date=20260311T194542Z&HW-CC-Expire=86400&HW-CC-Sign=3872788C23FDB8F78BC31261CBFC0B956A8A4D81CC0BF0C28F1B9E378B0F2BBA)

[状态管理V1和V2更新机制差异](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-v1-v2-update-difference "状态管理V1和V2更新机制差异")

[MVVM模式（V2）](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-mvvm-v2 "MVVM模式（V2）")

相关推荐

_文档_[状态管理V1和V2适用场景介绍](https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_88-0000002312256121 "状态管理V1和V2适用场景介绍")

_文档_[MVVM模式（V2）](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-mvvm-v2 "MVVM模式（V2）")

_文档_[Navigation通过pushPathByName跳转页面为什么显示空白](https://developer.huawei.com/consumer/cn/doc/harmonyos-faqs/faqs-arkui-415 "Navigation通过pushPathByName跳转页面为什么显示空白")

_文档_[如何实现V1、V2版本之间父子组件的数据传递与共享](https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_c133-0000002552396709 "如何实现V1、V2版本之间父子组件的数据传递与共享")

_文档_[状态管理最佳实践](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-status-management "状态管理最佳实践")

_文档_[渲染视频画面](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-video-render "渲染视频画面")

_文档_[页面上下滑动时组件闪动](https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_c259-0000002408797896 "页面上下滑动时组件闪动")

_文档_[流量变现服务开发概述](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ads-publisher-service-dev-overview "流量变现服务开发概述")

_文档_[interactiveLiveness（人脸活体检测）](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/vision-interactive-liveness "interactiveLiveness（人脸活体检测）")

_视频课程_[ArkUI状态管理开发指导](https://developer.huawei.com/consumer/cn/training/course/introduction/C201761552179953023 "ArkUI状态管理开发指导")
...
[MVVM模式介绍](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-mvvm#mvvm模式介绍)

[概念](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-mvvm#概念)

[ArkUI开发模式图](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-mvvm#arkui开发模式图)

[分层说明](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-mvvm#分层说明)

[架构核心原则](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-mvvm#架构核心原则)

[备忘录开发实战](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-mvvm#备忘录开发实战)

[@State状态变量](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-mvvm#state状态变量)

[@Prop、@Link的作用](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-mvvm#proplink的作用)

[循环渲染组件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-mvvm#循环渲染组件)

[@Builder方法](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-mvvm#builder方法)

[总结](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-mvvm#总结)

[通过MVVM开发备忘录实战](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-mvvm#通过mvvm开发备忘录实战)

[MVVM文件结构说明](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-mvvm#mvvm文件结构说明)

[分层设计技巧](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-mvvm#分层设计技巧)

[代码示例](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-mvvm#代码示例)
...
-   ![](https://developer.huawei.com/images/foot/3wx.png)
    ...
    ![](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/assets/images/head/hua_wei_kai_fa_zhe_lian_meng_fu_wu_wei_xin_er_wei_ma_fu_ben_0.jpg)
    
    微信公众号
    
-   ![](https://developer.huawei.com/images/foot/4app.png)
    
    ![](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/assets/images/head/APPerweima.png)
